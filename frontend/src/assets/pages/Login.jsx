                ...
                <form onSubmit={onSubmitHandler} className=' flex flex-col items-center w-[90%] sm:max-w-md m-auto gap-y-5'>
                    ...
                    {currState === 'Sign Up' && (
                        <div className=' w-full '>
                          ...
                          className=' w-full px-3 py-1.5 ring-1 ring-slate-900/5 rounded bg-primary
                          mt-1'/>
                        </div>
                    )}
                    <div className='w-full'>
                        ...
                        <div className=' underline medium-15'>Forgot your Password?</div>
                           ...
                           <div className=' underline medium-15 '>
                            ...
                            <span onClick={()=>setCurrState('Sign Up')}
                                className='cursor-pointer pl-1'>Create Account</span>
                           </div> </>
                        ):(
                            <div className=' underline medium-15 cursor-pointer '>
                            Already have an Account?
                            <span onClick={()=>setCurrState('Login')}
                                className='cursor-pointer pl-1'>Login</span>
                           </div>
                        )}
                    </div>
                </form>
